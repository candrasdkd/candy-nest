    ...
    try {
      ...
      if (txData.relatedPotId) {
        try {
          ...
          console.warn("Could not perform cascading deletion or update balance for savings pot (pot may have been deleted):", err);
        }
      }
    } catch (e) {
    ...
    try {
      ...
      if (oldTxData.relatedPotId) {
        try {
          ...
          console.warn("Could not sync related pot transaction (pot may have been deleted):", err);
        }
      }
    } catch (e) {
